...
namespace ETradingSystem1.WebApi.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] RegisterModel model)
        {
            ...
            if (!await roleManager.RoleExistsAsync(UserRoles.BUSINESSOWNER))
                await roleManager.CreateAsync(new IdentityRole(UserRoles.BUSINESSOWNER));
            ...
            else if (model.Role == UserRoles.BUSINESSOWNER)
            {

                if (await roleManager.RoleExistsAsync(UserRoles.BUSINESSOWNER))
                {
                    await userManager.AddToRoleAsync(user, UserRoles.BUSINESSOWNER);
                }
            }
